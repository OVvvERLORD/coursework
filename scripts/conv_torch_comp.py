...
test_input = torch.rand(30,20,128,128)
print(test_input)
save_file({"input_test" : test_input}, r"C:\study\coursework\src\trash\test_inp.safetensors")

tensors = load_file(r"C:\study\coursework\src\trash\test_inp.safetensors")
print(test_input - tensors["input_test"])
print(torch.allclose(test_input, tensors["input_test"], 1e-67))
