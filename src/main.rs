...
use blocks::down::Down_blocks;
use blocks::mid::mid_block;
use blocks::up::Up_blocks;
// use blocks::down;
use cudarc::{self};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // print!("{:?}", tensor);
    // let downblock2d = DownBlock2D::new(res1_params, 
    //     res2_params, 
    //     320, 320, 1, 2, 3, kernel_downblock2d_downsample.into_raw_vec_and_offset().0, c_downblock2d_downsample_b, true,
    //      Rc::clone(&res_hidden_states));
    // let _ = downblock2d.operation(&mut tensor);
    // let crossattnblock2d1 = CrossAttnDownBlock2D::new(crossattndownblock2d_1_params);
    // let _ = crossattnblock2d1.operation(&mut tensor);
    // print!("{:?}", tensor);
